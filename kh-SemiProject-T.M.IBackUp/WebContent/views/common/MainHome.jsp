		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<h2 class="text-white mt-0">MOVIE SELECTION</h2>
					<hr class="divider light my-4">
					<p class="text-white-50 mb-4">영화 동영상 추가 고고!!</p>
					...
					<div class="content-wrap">
						...
						<div class="container clearfix">
							<div class="col_two_third portfolio-single-image nobottommargin">
								<iframe id="video1" width="850" height="405"
									src="https://www.youtube.com/embed/0uC2FaZ4h1I" frameborder="0"
									allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
									allowfullscreen></iframe>
							</div>
							<div>
								<img src="../startbootstrap-creative-gh-pages/img/가장보통.jpg"
