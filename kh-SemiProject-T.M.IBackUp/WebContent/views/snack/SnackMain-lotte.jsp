...
<%@include file ="../common/menubar.jsp" %>
	<br><br><br><br>
	<div id="snack-main-image"><img src="<%= request.getContextPath() %>/resources/images/movie/스낵3.jpg"></div>
    ...
    <div id="snack-prd">
     <%if(sn.isEmpty()){ %>
			...
			<li id="snack-prd-li">
	            ...
	            <img id="detail-image"  src="<%= request.getContextPath() %>/resources/images/snackimage/lotteSnack/<%= s.getPicture() %>.jpg" height="200px">
	            <dl>
	...
	<script>
     ...
     <script>
          ...
          function goSnackCom(){
    			location.href="<%=request.getContextPath()%>/SnackList.sn?kinds=c";
    		}
          function goSnackPop(){
  			location.href="<%=request.getContextPath()%>/SnackList.sn?kinds=p";
  		}
          function goSnackDri(){
  			location.href="<%=request.getContextPath()%>/SnackList.sn?kinds=d";
  		}
          function goSnackEtc(){
  			location.href="<%=request.getContextPath()%>/SnackList.sn?kinds=e";
  		}
