        ...
        <%if(de.isEmpty()){ %>
            ...
            <div id="snack-detail-inner">
                <div id="snack-detail-left">
                    <img id="pd-image" src="<%= request.getContextPath() %>/resources/images/snackimage/lotteSnack/<%= s.getPicture() %>.jpg"alt="">
                </div>
                <div id="snack-detail-right">
                        ...
                        <button id="snack-all-list" onclick="goSnacklt();">상품 리스트</button>
                </div>
            </div>
        </div>
