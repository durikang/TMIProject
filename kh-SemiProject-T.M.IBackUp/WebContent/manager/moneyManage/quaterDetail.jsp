		                    ...
		                    <div class="tableArea">
			                    <table id="table">
                                           ...
                                           <script language="javascript">
                                                for(i=0; i<=10; i++){
                                                    document.write("<tr>");
                                                        document.write("<td width=25%>eventname</td>");
                                                        document.write("<td width=25%><input type='range' value='0' min='0' max='20' value='sale'></td>");
                                                        document.write("<td width=25%><input type='button' value='설정여부'>설정여부</input></td>");
                                                    document.write("</tr>");
                                                }
                                            </script>
                                </table>
