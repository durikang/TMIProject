...
public class MyPage implements java.io.Serializable{
	...
	public MyPage(String userNum, String userId, String userPw, String userName, String birth, String phone,
	...
	public String toString() {
		return "MyPage [userNum=" + userNum + ", userId=" + userId + ", userPw=" + userPw + ", userName=" + userName
